...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/auth-basic-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Dec 2024 17:51:18 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <!-- loader-->
	...
	<script href="{{asset ('second/assets/js/pace.min.js') }}"></script>

  <!--plugins-->
  <link href="{{asset ('second/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css') }}" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="{{asset ('second/assets/plugins/metismenu/metisMenu.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{asset ('second/assets/plugins/metismenu/mm-vertical.css') }}">
  <!--bootstrap css-->
  ...
  <!--authentication-->
           ...
           <div class="col-12 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mx-auto">
            <div class="card rounded-4 mb-0 border-top border-4 border-primary border-gradient-1">
              <div class="card-body p-5">
                  <img href="{{asset ('second/assets/images/logo1.png') }}" class="mb-4" width="145" alt="">
    ...
    <!--plugins-->
    <script href="{{asset ('second/assets/js/jquery.min.js') }}"></script>
