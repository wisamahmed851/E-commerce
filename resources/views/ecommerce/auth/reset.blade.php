...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/pages/authentication/card/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2024 15:41:43 GMT -->
                ...
                <div class="row g-0 h-100">
                  ...
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form class="mt-3">
                        <div class="mb-3"><label class="form-label" for="card-reset-password">New Password</label><input class="form-control" type="password" id="card-reset-password" /></div>
                        <div class="mb-3"><label class="form-label" for="card-reset-confirm-password">Confirm Password</label><input class="form-control" type="password" id="card-reset-confirm-password" /></div><button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Set password</button>
                      </form>
                    </div>
                  </div>
                </div>
