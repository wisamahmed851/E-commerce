...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2024 15:39:12 GMT -->
<!-- Added by HTTrack -->
...
<link rel="stylesheet" href="path/to/froala_editor.pkgd.min.css">
<script src="path/to/froala_editor.pkgd.min.js"></script>
<link href="https://cdn.quilljs.com/1.3.7/quill.snow.css" rel="stylesheet">
<script src="https://cdn.quilljs.com/1.3.7/quill.min.js"></script>


<!-- Add Bootstrap JS in your script -->
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <style>
        ...
        .form-switch .form-check-input:checked {
          background-color: #007aff; /* Blue when toggled on */
        }
...
<body>
                                        ...
                                        <div class="scrollbar list py-3" style="max-height: 24rem;">
                                            ...
                                            <a class="dropdown-item px-x1 py-1 fs-9"
                                                ...
                                                <div class="d-flex align-items-center"><span
                                                    ...
                                                    <div class="flex-1 fs-10 title">Latest events in current month
                                                    </div>
                                                </div>
                                            </a>
                                            <a class="dropdown-item px-x1 py-1 fs-9"
                                                href="{{ route('products.grid') }}">
                                                <div class="d-flex align-items-center"><span
                                            ...
                                            <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="file-thumbnail me-2"><img
                                                            ...
                                                            src="{{ asset('assets/img/products/3-thumb.png') }}"
                                                            alt="" /></div>
                                                    <div class="flex-1">
                                            ...
                                            <a class="dropdown-item px-x1 py-2" href="{{ route('users.profile') }}">
                                                <div class="d-flex align-items-center">
                                                ...
                                                <div class="list-group-item">
                                                    <a class="border-bottom-0 notification notification-flush"
                                                        ...
                                                        <div class="notification-avatar">
                                                            <div class="avatar avatar-xl me-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('assets/img/team/10.jpg') }}"
                                                                    alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="notification-body">
                            ...
                            <li class="nav-item dropdown px-1">
                                <a class="nav-link fa-icon-wait nine-dots p-1" id="navbarDropdownMenu" role="button"
                                    ...
                                    aria-haspopup="true" aria-expanded="false"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="43"
                                            ...
                                            <div class="card-body px-3">
                                                <div class="row text-center gx-0 gy-0">
                                                    <div class="col-4"><a
                                                            ...
                                                            href="{{ route('users.profile') }}" target="_blank">
                                                    ...
                                                    <div class="col-4"><a
                                                            ...
                                                            href="#!" target="_blank"><img class="rounded"
                                                                src="{{ asset('assets/img/nav-icons/google.png') }}"
                                                                alt="" width="40" height="40" />
                                                            <p
                                                                class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">
                                                                Google</p>
                                                    ...
                                                    <div class="col-4"><a
                                                            class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                            href="#!" target="_blank"><img class="rounded"
                                                                src="{{ asset('assets/img/nav-icons/steam.png') }}"
                                                                alt="" width="40" height="40" />
                                                            <p
                                                                class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">
                                                                Steam</p>
                                                    ...
                                                    <div class="col-4"><a
                                                            class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                            href="#!" target="_blank"><img class="rounded"
                                                                src="{{ asset('assets/img/nav-icons/xbox.png') }}"
                                                                alt="" width="40" height="40" />
                                                            <p
                                                                class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">
                                                                xbox</p>
                                                    ...
                                                    <div class="col-4"><a
                                                            class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                            href="#!" target="_blank"><img class="rounded"
                                                                src="{{ asset('assets/img/nav-icons/trello.png') }}"
                                                                alt="" width="40" height="40" />
                                                            <p
                                                                class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">
                                                                Kanban</p>
                                                    ...
                                                    <div class="col-4"><a
                                                            class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                            href="#!" target="_blank"><img class="rounded"
                                                                src="{{ asset('assets/img/nav-icons/hp.png') }}"
                                                                alt="" width="40" height="40" />
                                                            <p
                                                                class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">
                                                                Hp</p>
                                                    ...
                                                    <div class="col-4"><a
                                                            class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                                            href="#!" target="_blank"><img class="rounded"
                                                                src="{{ asset('assets/img/nav-icons/slack.png') }}"
                                                                alt="" width="40" height="40" />
                                                            <p
                                                                class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">
                                                                Slack</p>
                            ...
                            <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser"
                                ...
                                <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                                    ...
                                    <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                        ...
                                        <a class="dropdown-item" href="{{ route('users.profile') }}">Profile &amp;
                                            account</a>
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                                ...
                                <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0"
                                    ...
                                    <div class="bg-white dark__bg-1000 rounded-3 py-2"><a
                                            ...
                                            class="dropdown-item link-600 fw-medium"
                                            href="{{ route('dashboard.index') }}">E commerce</a><a
                                            class="dropdown-item link-600 fw-medium"
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <div class="nav flex-column">
                                                        <p class="nav-link text-700 mb-0 fw-bold">E-Commerce</p><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('products.index') }}">Product list</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('products.grid') }}">Product grid</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('products.details') }}">Product
                                                            details</a><a class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('products.create') }}">Add product</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('orders.index') }}">Order list</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('orders.detail') }}">Order details</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('customers.index') }}">Customers</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('customers.detail') }}">Customer
                                                            details</a><a class="nav-link py-1 link-600 fw-medium"
                                                ...
                                                <div class="col-6 col-xxl-3">
                                                    <div class="nav flex-column">
                                                        <p class="nav-link text-700 mb-0 fw-bold">Card Auth</p><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('auth.login') }}">Login</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="pages/authentication/card/logout.html">Logout</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('auth.register') }}">Register</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('auth.forgot') }}">Forgot password</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('auth.confirm') }}">Confirm mail</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('auth.reset') }}">Reset password</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('auth.lock') }}">Lock screen</a>
                                                    </div>
                                                </div>
                                                <div class="col-6 col-xxl-3">
                                                    <div class="nav flex-column">
                                                ...
                                                <div class="col-6 col-xxl-3">
                                                    <div class="nav flex-column">
                                                        <p class="nav-link text-700 mb-0 fw-bold">User</p><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('users.profile') }}">Profile</a><a
                                                            class="nav-link py-1 link-600 fw-medium"
                                                            href="{{ route('users.setting') }}">Settings</a>
                                                    </div>
                                                </div>
                                                <div class="col-6 col-xxl-3">
                                                    <div class="nav flex-column">
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item"><!-- label-->
                                ...
                                </div><!-- parent pages--><a class="nav-link" href="{{ route('users.index') }}"
                                    role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <ul class="nav collapse" id="e-commerce">
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-indicator" href="#product" data-bs-toggle="collapse" aria-expanded="false" aria-controls="product">
                                        ...
                                        <ul class="nav collapse" id="product">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="{{ route('products.grid') }}">
                                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Product grid</span></div>
                                            </a></li>
                                            <li class="nav-item"><a class="nav-link" href="{{ route('products.details') }}">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-indicator" href="#category" data-bs-toggle="collapse" aria-expanded="false" aria-controls="category">
                                        ...
                                        <ul class="nav collapse" id="category">
                                            <li class="nav-item"><a class="nav-link" href="{{ route('category.create') }}">
                                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Add Category</span></div>
                                            </a></li>
                                ...
                                </ul><!-- parent pages--><a class="nav-link" href="app/kanban.html"
                                    role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <ul class="nav collapse" id="support-desk">
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Card view</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link"
                            ...
                            <li class="nav-item"><!-- label-->
                                ...
                                <ul class="nav collapse" id="user">
                                    <li class="nav-item"><a class="nav-link" href="{{ route('users.profile') }}">
                                            <div class="d-flex align-items-center"><span
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{ route('users.setting') }}">
                                            <div class="d-flex align-items-center"><span
                                ...
                                <a class="nav-link dropdown-indicator" href="#pricing" role="button"
                                ...
                                <a class="nav-link dropdown-indicator" href="#faq" role="button"
                                ...
                                <ul class="nav collapse" id="faq">
                                    <li class="nav-item"><a class="nav-link" href="pages/faq/faq-basic.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Faq basic</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link" href="pages/faq/faq-alt.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Faq alt</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link" href="pages/faq/faq-accordion.html">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Faq accordion</span></div>
                                        </a><!-- more inner pages--></li>
                                </ul><!-- parent pages-->


                                <a class="nav-link dropdown-indicator" href="#errors" role="button"
                            ...
                            <li class="nav-item"><!-- label-->
                                ...
                                <ul class="nav collapse" id="tables">
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Bulk select</span></div>
                                        </a><!-- more inner pages--></li>
                                ...
                                <ul class="nav collapse" id="icons">
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Font awesome</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link"
                                ...
                                <ul class="nav collapse" id="components">
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">List group</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link"
                                    ...
                                    <li class="nav-item"><a class="nav-link dropdown-indicator"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Navs &amp; Tabs</span></div>
                                        </a><!-- more inner pages-->
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Sortable</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link"
                                ...
                                <ul class="nav collapse" id="utilities">
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Icon link</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link"
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Text truncation</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link"
                            ...
                            <li class="nav-item"><!-- label-->
                                ...
                                </div><!-- parent pages--><a class="nav-link"
                                ...
                                <ul class="nav collapse" id="customization">
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Dark mode</span></div>
                                        </a><!-- more inner pages--></li>
                                    <li class="nav-item"><a class="nav-link"
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="nav flex-column">
                                                    <p class="nav-link text-700 mb-0 fw-bold">E-Commerce</p><a
                                                        ...
                                                        href="{{ route('products.grid') }}">Product grid</a><a
                                                        class="nav-link py-1 link-600 fw-medium"
                                                        href="{{ route('products.details') }}">Product details</a><a
                                                        class="nav-link py-1 link-600 fw-medium"
                                                        href="{{ route('products.create') }}">Add product</a><a
                                                        class="nav-link py-1 link-600 fw-medium"
                                                        href="{{ route('orders.index') }}">Order list</a><a
    ...
    <!-- Tagify JS -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/tagify/4.21.1/tagify.min.js"
        integrity="sha512-e1PLou9D3vRJUgA/hH/a+xOasrGwqiIvTmoufWjcb8SNA10X/gKxQW/JMNIJaTHi9JuzCqbO+I2+9EvIfcM7Kw=="
    ...
    <script src="{{ asset('assets/js/custom/ajaxPost.js') }}"></script>
    <script src="{{ asset('assets/js/custom/filemanager.js') }}"></script>
    <!-- Humming Bird JS -->
    <!-- Custom Js -->
    <script>
...
<!-- Mirrored from prium.github.io/falcon/v3.21.0/dashboard/e-commerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2024 21:22:19 GMT -->
