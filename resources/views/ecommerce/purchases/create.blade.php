                            ...
                            <div id="productSelection">
                                <div class="product-row mb-3">
                                    ...
                                    <input type="number" class="form-control price-input mt-2"
                                           name="products[0][purchase_price]" placeholder="Enter purchase price" required>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('addProduct').addEventListener('click', function () {
                ...
                productRow.innerHTML = `
                    ...
                    <input type="number" class="form-control price-input mt-2"
                           name="products[${productIndex}][purchase_price]" placeholder="Enter purchase price" required>
                    <input type="number" class="form-control discount-input mt-2"
            ...
            document.getElementById('productSelection').addEventListener('change', function (e) {
                if (e.target.classList.contains('product-select')) {
                    ...
                    const imageContainer = e.target.closest('.product-row').querySelector('.selected-product-image');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            setTimeout(() => window.location.href = '{{ route('purchase.index') }}', 1500);
                        }
                    },
                    error: function (xhr) {
