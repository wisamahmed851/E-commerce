            ...
            <div class="card rounded-4">
                <div class="card-body p-4">
                    <div class="position-relative mb-5">
                        <img src="{{asset('second/assets/images/gallery/profile-cover.html') }}" class="img-fluid rounded-4 shadow"
                            alt="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="account-list d-flex flex-column gap-4">
                                <div class="account-list-item d-flex align-items-center gap-3">
                                    <img src="{{asset('second/assets/images/apps/05.png') }}" width="35" alt="">
                                ...
                                <div class="account-list-item d-flex align-items-center gap-3">
                                    <img src="{{asset('second/assets/images/apps/02.png') }}" width="35" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="account-list-item d-flex align-items-center gap-3">
                                    <img src="{{asset('second/assets/images/apps/03.png') }}" width="35" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="account-list-item d-flex align-items-center gap-3">
                                    <img src="{{asset('second/assets/images/apps/06.png') }}" width="35" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="account-list-item d-flex align-items-center gap-3">
                                    <img src="{{asset('second/assets/images/apps/17.png') }}" width="35" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="account-list-item d-flex align-items-center gap-3">
                                    <img src="{{asset('second/assets/images/apps/11.png') }}" width="35" alt="">
                                    <div class="flex-grow-1">
