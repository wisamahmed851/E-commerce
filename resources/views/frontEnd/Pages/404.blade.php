...
<!-- Mirrored from cartzilla-html.createx.studio/404-grocery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2024 15:38:51 GMT -->
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Cartzilla | Grocery Store - 404 Error</title>
  ...
  <body>
    ...
    <header class="navbar navbar-expand navbar-sticky sticky-top d-block bg-body z-fixed py-1 py-lg-0 py-xl-1 px-0" data-sticky-element="">
      <div class="container justify-content-start py-2 py-lg-3">
        ...
        <!-- Navbar brand (Logo) -->
        <a class="navbar-brand fs-2 p-0 pe-lg-2 pe-xxl-0 me-0 me-sm-3 me-md-4 me-xxl-5" href="home-grocery.html">Cartzilla</a>
        ...
        <div class="text-center px-2 px-sm-0 mx-auto" style="max-width: 636px">
          <div class="position-relative mb-4 mb-sm-5 mx-auto" style="max-width: 542px">
            <div class="ratio ratio-1x1 position-absolute top-50 start-0 translate-middle-y">
              <img src="{{asset('frontend/assets/img/404/grocery.png')}}" class="animate-spin" alt="Lemon">
            </div>
          ...
          <div class="position-relative z-2">
            ...
            <a class="btn btn-lg btn-outline-dark rounded-pill" href="{{route('front.index')}}">Go to homepage</a>
          </div>
        </div>
      </section>
      <img src="{{asset('frontend/assets/img/404/grocery-bg-1.png')}}" class="animate-up-down position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Background image">
      <img src="{{asset('frontend/assets/img/404/grocery-bg-2.png')}}" class="animate-down-up position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Background image">
    </main>
...
<!-- Mirrored from cartzilla-html.createx.studio/404-grocery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2024 15:38:54 GMT -->
</html>
