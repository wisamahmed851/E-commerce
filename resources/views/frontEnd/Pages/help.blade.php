          ...
          <div class="swiper-wrapper">
            ...
            <article class="swiper-slide">
              <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="help-single-article-v1.html" style="--cz-aspect-ratio: calc(306 / 416 * 100%)">
                <img src="{{asset('frontend/assets/img/help/article01.jpg')}}" class="hover-effect-target" alt="Image">
              </a>
              <div class="pt-4">
            ...
            <article class="swiper-slide">
              <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="help-single-article-v1.html" style="--cz-aspect-ratio: calc(306 / 416 * 100%)">
                <img src="{{asset('frontend/assets/img/help/article02.jpg')}}" class="hover-effect-target" alt="Image">
              </a>
              <div class="pt-4">
            ...
            <article class="swiper-slide">
              <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="help-single-article-v1.html" style="--cz-aspect-ratio: calc(306 / 416 * 100%)">
                <img src="{{asset('frontend/assets/img/help/article03.jpg')}}" class="hover-effect-target" alt="Image">
              </a>
              <div class="pt-4">
            ...
            <article class="swiper-slide">
              <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="help-single-article-v1.html" style="--cz-aspect-ratio: calc(306 / 416 * 100%)">
                <img src="{{asset('frontend/assets/img/help/article04.jpg')}}" class="hover-effect-target" alt="Image">
              </a>
              <div class="pt-4">
