              ...
              <table class="table align-middle fs-sm text-nowrap">
                ...
                <tbody class="text-body-emphasis orders-list">
                  ...
                  <tr>
                    ...
                    <td class="py-3 pe-0">
                      <span class="d-flex align-items-center justify-content-end position-relative gap-1 gap-sm-2 ms-n2 ms-sm-0">
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/20.png')}}" width="64" alt="Thumbnail"></span>
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/16.png')}}" width="64" alt="Thumbnail"></span>
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/15.png')}}" width="64" alt="Thumbnail"></span>
                  ...
                  <tr>
                    ...
                    <td class="py-3 pe-0">
                      <span class="d-flex align-items-center justify-content-end position-relative gap-1 gap-sm-2 ms-n2 ms-sm-0">
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/14.png')}}" width="64" alt="Thumbnail"></span>
                        <a class="btn btn-icon btn-ghost btn-secondary stretched-link border-0" href="#orderDetails" data-bs-toggle="offcanvas" aria-controls="orderDetails" aria-label="Show order details">
                          <i class="ci-chevron-right fs-lg"></i>
                        </a>
                      </span>
                  ...
                  <tr>
                    ...
                    <td class="py-3 pe-0">
                      <span class="d-flex align-items-center justify-content-end position-relative gap-1 gap-sm-2 ms-n2 ms-sm-0">
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/12.png')}}" width="64" alt="Thumbnail"></span>
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/13.png')}}" width="64" alt="Thumbnail"></span>
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/18.png')}}" width="64" alt="Thumbnail"></span>
                  ...
                  <tr>
                    ...
                    <td class="py-3 pe-0">
                      <span class="d-flex align-items-center justify-content-end position-relative gap-1 gap-sm-2 ms-n2 ms-sm-0">
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/21.png')}}" width="64" alt="Thumbnail"></span>
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/11.png')}}" width="64" alt="Thumbnail"></span>
                        <a class="btn btn-icon btn-ghost btn-secondary stretched-link border-0" href="#orderDetails" data-bs-toggle="offcanvas" aria-controls="orderDetails" aria-label="Show order details">
                          <i class="ci-chevron-right fs-lg"></i>
                        </a>
                      </span>
                  ...
                  <tr>
                    ...
                    <td class="py-3 pe-0">
                      <span class="d-flex align-items-center justify-content-end position-relative gap-1 gap-sm-2 ms-n2 ms-sm-0">
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/17.png')}}" width="64" alt="Thumbnail"></span>
                        <a class="btn btn-icon btn-ghost btn-secondary stretched-link border-0" href="#orderDetails" data-bs-toggle="offcanvas" aria-controls="orderDetails" aria-label="Show order details">
                          <i class="ci-chevron-right fs-lg"></i>
                        </a>
                      </span>
                  ...
                  <tr>
                    ...
                    <td class="py-3 pe-0">
                      <span class="d-flex align-items-center justify-content-end position-relative gap-1 gap-sm-2 ms-n2 ms-sm-0">
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/19.png')}}" width="64" alt="Thumbnail"></span>
                        <span><img src="{{asset('frontend/assets/img/shop/electronics/thumbs/22.png')}}" width="64" alt="Thumbnail"></span>
                        <a class="btn btn-icon btn-ghost btn-secondary stretched-link border-0" href="#orderDetails" data-bs-toggle="offcanvas" aria-controls="orderDetails" aria-label="Show order details">
                          <i class="ci-chevron-right fs-lg"></i>
                        </a>
                      </span>
