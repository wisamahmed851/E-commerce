...
<!-- Mirrored from cartzilla-html.createx.studio/account-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2024 15:37:21 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <script src="{{ asset('frontendassets/js/theme-switcher.js') }}"></script>
    ...
    <!-- Customizer -->
    <script src="{{ asset('frontendassets/js/customizer.min.js') }}"></script>
</head>
...
<body>
            ...
            <div class="customizer-collapse collapse" id="customizerCode">
                ...
                <p class="fs-sm pb-1">To apply the provided styles to your webpage, enclose them within a
                    ...
                    your HTML document after the following link to the main stylesheet:<br><code>&lt;link
                        href="{{ asset('frontend/assets/css/theme.min.css') }}"&gt;</code></p>
    ...
    <script src="{{ asset('frontendassets/js/theme.min.js') }}"></script>
